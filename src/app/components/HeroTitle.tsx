...
export default function HeroTitle() {
    ...
    return (
        <div>
            ...
            >
                Delivering
                <span className="gradient-accent"> scalable solutions </span>
            </MotionTag>
            <MotionTag
                tag="h1"
            ...
            <MotionTag
                ...
                initial="hidden"
                animate="visible"
                className="mt-4 text-center lg:text-left text-base sm:text-lg md:text-xl max-w-3xl mx-auto lg:mx-0"
            >
